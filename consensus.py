...
3. Call out major risks and how to mitigate them.
...
- If the problem is underspecified, include a short "Open questions" section with up to 5 questions.
- Keep the whole response under ~250 lines; prefer concise bullets.
...
Be concise but specific. Do not invent financial numbers unless the problem already provided them.
"""
